...
cbx_pages = xbmc.translatePath(os.path.join('special://home/userdata/adon_data/plugin.video.tv.ultra.7k/art/cbx', ''))
playlists = xbmc.translatePath(os.path.join('special://home/userdata/addon_data/plugin.video.tv.ultra.7k/playlists', ''))
tmp = xbmc.translatePath(os.path.join('special://home/userdata/addon_data/plugin.video.tv.ultra.7k/tmp', ''))
