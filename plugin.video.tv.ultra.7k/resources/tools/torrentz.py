# -*- coding: utf-8 -*-
#------------------------------------------------------------
# TV Ultra 7K Parser de Torrentz.eu
...
def torrentz(params):
    plugintools.log("[tv.ultra.7k 0.3.0].Torrentz "+repr(params))
...
def torrentz_links(params):
    plugintools.log("[tv.ultra.7k Torrentz links]"+repr(params))
...
def torrentz_getmagnet(params):
    plugintools.log("tv.ultra.7k torrentz_getmagnet "+repr(params))
...
def gethttp_referer_headers(url,referer):
    plugintools.log("tv.ultra.7k-0.3.0.gethttp_referer_headers ")
    request_headers=[]
