...
def seriesflv(params):
    plugintools.log("[tv.ultra.7k 0.3.0].SeriesFLV")
    ...
    plugintools.add_item(action="lista_chapters", title='[COLOR orange]Subtitulada[/COLOR]' , url = url, thumbnail = thumbnail , info_labels = datamovie, fanart = fanart , folder = True, isPlayable = False)
    plugintools.add_item(action="lista_chapters", title='[COLOR orange]Español[/COLOR]' , url = url, thumbnail = thumbnail , info_labels = datamovie, fanart = fanart , folder = True, isPlayable = False)
    plugintools.add_item(action="lista_chapters", title='[COLOR orange]Latino[/COLOR]' , url = url, thumbnail = thumbnail , info_labels = datamovie, fanart = fanart , folder = True, isPlayable = False)
    plugintools.add_item(action="lista_chapters", title='[COLOR orange]V.O.[/COLOR]' , url = url, thumbnail = thumbnail , info_labels = datamovie, fanart = fanart , folder = True, isPlayable = False)
...
def listado_seriesflv(params):
    plugintools.log("tv.ultra.7k.[listado_seriesflv] "+repr(params))
