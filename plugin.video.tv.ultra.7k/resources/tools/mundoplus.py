# -*- coding: utf-8 -*-
#------------------------------------------------------------
# Mundoplus.tv parser para TV Ultra 7K
...
def mundoplus_guide(params):
    plugintools.log("[tv.ultra.7k 0.3.3].Mundoplus.tv "+repr(params))
...
def mundoplus0(params):
    ...
    try:
        ...
        params["plot"]=texto
        texto = texto.lower()        
        if texto == "": errormsg = plugintools.message("TV Ultra 7K","Por favor, introduzca serie a buscar");return errormsg
        else:
