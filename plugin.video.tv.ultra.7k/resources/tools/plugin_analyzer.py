...
def plugin_analyzer(data, title, plot, datamovie, thumbnail, fanart, show):
    ...
    if data.startswith("plugin://plugin.video.SportsDevil/") == True:
        ...
        plugintools.add_item( action = "runPlugin" , title = '[COLOR white]' + title + '[COLOR blue] [B][/B][/COLOR]', plot = plot , url = data.strip() , info_labels = datamovie, thumbnail = thumbnail , show = show, fanart = fanart , folder = False , isPlayable = True )
        ...
        plugintools.add_item( action = "runPlugin" , title = '[COLOR white]' + title + '[COLOR blue][B] [LiveStreams][/B][/COLOR]', url = data.strip() , info_labels = datamovie, thumbnail = thumbnail , fanart = fanart , show = show, folder = False , isPlayable = False )
