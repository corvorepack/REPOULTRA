# -*- coding: utf-8 -*-
#------------------------------------------------------------
# TV Ultra 7K GetPoster (módulo de descarga de posters de películas)
...
def scraperfilm(title):
    plugintools.log("[ScraperFilm tv.ultra.7k] "+title)
...
def save_title(title, datamovie, filename):
    plugintools.log("tv.ultra.7k Saving data... "+repr(datamovie))
...
def save_url(url, filename):
    plugintools.log("tv.ultra.7k Saving URL...")
