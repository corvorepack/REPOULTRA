...
def rtmp_analyzer(params):
    plugintools.log('[%s %s] RTMP Analyzer tv.ultra.7k %s' % (addonName, addonVersion, repr(params)))
...
def url_analyzer(params):
    ...
    if url.startswith("plugin") == True:
        ...
        plot = params.get("plot")
        title=params.get("title")  # .replace("[Multi]", "").strip()
        ruta_llamadas = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.tv.ultra.7k/resources/llamadas/', ''))  # Esto irá en default.py
        ...
        if server == "copiapop":
            plugintools.add_item(action=server, title=title, url=url, thumbnail=thumbnail, fanart=fanart, info_labels=datamovie, folder=True, isPlayable=False)
        elif url.find("lolabits") >= 0:
            plugintools.add_item(action="lb_regex", title=title, url='multiparser'+url.strip(), thumbnail=thumbnail, fanart=fanart, info_labels=datamovie, folder=True, isPlayable=False)              
        elif server != "unknown":
...
def multilink(params):
    plugintools.log('[%s %s] tv.ultra.7k Multilink %s' % (addonName, addonVersion, repr(params)))
...
def multiparse_title(title, url):
    if url == "mundoplus":
        title = title + ' [COLOR lightyellow][B][Guía[B]TV[/B]][/B][/COLOR]' 

    elif url.startswith("serie") == True:
        if url.find("seriesflv") >= 0:
            title = title + ' [COLOR lightyellow][B][Series[B]FLV[/B]][/B][/COLOR]'
        if url.find("seriesyonkis") >= 0:
            title = title + ' [COLOR lightyellow][B][Series[B]Yonkis[/B]][/B][/COLOR]'
        if url.find("seriesadicto") >= 0:
            title = title + ' [COLOR lightyellow][B][Series[B]Adicto[/B]][/B][/COLOR]'
        if url.find("seriesblanco") >= 0:
            title = title + ' [COLOR lightyellow][B][Series[B]Blanco[/B]][/B][/COLOR]'
        if url.find("series.mu") >= 0:
            title = title + ' [COLOR lightyellow][B][Series[B].Mu[/B]][/B][/COLOR]'

    elif url.startswith("peli") == True:
        if url.find("oranline") >= 0:
            title = title + ' [COLOR lightyellow][B][Oranline][/B][/COLOR]'
        if url.find("pelisadicto") >= 0:
            title = title + ' [COLOR lightyellow][B][PelisAdicto][/B][/COLOR]'
        if url.find("pordede") >= 0:
            title = title + ' [COLOR lightyellow][B][Pordede][/B][/COLOR]'
        if url.find("openload") >= 0:
            title = title + ' [COLOR lightyellow][B][Openload][/B][/COLOR]'

    elif url.startswith("txt:") == True:
        title = title + ' [COLOR lightyellow][B][TXT][/B][/COLOR]'

    elif url.startswith("epg-txt:") == True:
        title = title + ' [COLOR lightyellow][B][EPG-TXT][/B][/COLOR]'        

    elif url.startswith("goear") == True:
        title = title + ' [COLOR lightyellow][B][goear][/B][/COLOR]'        

    elif url.startswith("http") == True:        
        if url.find("allmyvideos") >= 0:
            title = title + ' [COLOR lightyellow][B][Allmyvideos][/B][/COLOR]'

        elif url.find("streamcloud") >= 0:
            title = title + ' [COLOR lightyellow][B][Streamcloud][/B][/COLOR]'

        elif url.find("vidspot") >= 0:
            title = title + ' [COLOR lightyellow][B][Vidspot][/B][/COLOR]'
            
        elif url.find("played.to") >= 0:
            title = title + ' [COLOR lightyellow][B][Played.to][/B][/COLOR]'       

        elif url.find("vk.com") >= 0:
            title = title + ' [COLOR lightyellow][B][Vk][/B][/COLOR]'

        elif url.find("nowvideo") >= 0:
            title = title + ' [COLOR lightyellow][B][Nowvideo.sx][/B][/COLOR]'            
        
        elif url.find("tumi") >= 0:
            title = title + ' [COLOR lightyellow][B][Tumi][/B][/COLOR]'

        elif url.find("streamin.to") >= 0:
            title = title + ' [COLOR lightyellow][B][Streamin.to][/B][/COLOR]'

        elif url.find("veehd") >= 0:
            title = title + ' [COLOR lightyellow][B][Veehd][/B][/COLOR]'
            
        elif url.find("tumi.tv") >= 0:
            title = title + ' [COLOR lightyellow][B][Tumi.tv][/B][/COLOR]'       

        elif url.find("novamov") >= 0:
            title = title + ' [COLOR lightyellow][B][Novamov][/B][/COLOR]'

        elif url.find("gamovideo") >= 0:
            title = title + ' [COLOR lightyellow][B][Gamovideo][/B][/COLOR]'            
        
        elif url.find("moevideos") >= 0:
            title = title + ' [COLOR lightyellow][B][Moevideos][/B][/COLOR]'

        elif url.find("movshare") >= 0:
            title = title + ' [COLOR lightyellow][B][Movshare][/B][/COLOR]'

        elif url.find("powvideo") >= 0:
            title = title + ' [COLOR lightyellow][B][Powvideo][/B][/COLOR]'

        elif url.find("mail.ru") >= 0:
            title = title + ' [COLOR lightyellow][B][Mail.ru][/B][/COLOR]'

        elif url.find("videobam") >= 0:
            title = title + ' [COLOR lightyellow][B][Videobam][/B][/COLOR]'
            
        elif url.find("videoweed") >= 0:
            title = title + ' [COLOR lightyellow][B][Videoweed][/B][/COLOR]'

        elif url.find("streamable") >= 0:
            title = title + ' [COLOR lightyellow][B][Streamable][/B][/COLOR]'

        elif url.find("rocvideo") >= 0:
            title = title + ' [COLOR lightyellow][B][Rocvideo][/B][/COLOR]'

        elif url.find("realvid") >= 0:
            title = title + ' [COLOR lightyellow][B][Realvid][/B][/COLOR]'

        elif url.find("netu") >= 0:
            title = title + ' [COLOR lightyellow][B][Netu][/B][/COLOR]'

        elif url.find("waaw") >= 0:
            title = title + ' [COLOR lightyellow][B][Waaw.tv][/B][/COLOR]'            

        elif url.find("videomega") >= 0:
            title = title + ' [COLOR lightyellow][B][Videomega][/B][/COLOR]'

        elif url.find("video.tt") >= 0:
            title = title + ' [COLOR lightyellow][B][Video.tt][/B][/COLOR]'

        elif url.find("flashx.tv") >= 0:
            title = title + ' [COLOR lightyellow][B][Flashx][/B][/COLOR]'

        elif url.find("ok.ru") >= 0:
            title = title + ' [COLOR lightyellow][B][Ok.ru][/B][/COLOR]'

        elif url.find("vidto.me") >= 0:
            title = title + ' [COLOR lightyellow][B][Vidto.me][/B][/COLOR]'

        elif url.find("turbovideos") >= 0:
            title = title + ' [COLOR lightyellow][B][Turbovideos][/B][/COLOR]'            

        elif url.find("openload") >= 0:
            title = title + ' [COLOR lightyellow][B][Openload][/B][/COLOR]'

        elif url.find("copiapop") >= 0:
            title = title + ' [COLOR lightyellow][B][Copiapop][/B][/COLOR]'                 

        elif url.find("www.youtube.com") >= 0:
            title = title + ' [COLOR lightyellow][B][Youtube][/B][/COLOR]'
            ...
            title = title + ' [COLOR lightyellow][B][HTTP][/B][/COLOR]'
        ...
        if url.startswith("plugin://plugin.video.SportsDevil/") == True:
            ...
            title = title + ' [COLOR blue][B][Livestreams][/B][/COLOR]'
            ...
            title = title + ' [COLOR lightyellow][B][[B]Pelis[/B]alacarta][/B][/COLOR]'            
