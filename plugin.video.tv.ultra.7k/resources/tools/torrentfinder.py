# -*- coding: utf-8 -*-
#------------------------------------------------------------
# TV Ultra 7K Parser de Kickasstorrents.to
...
def bum(params):
    plugintools.log("[tv.ultra.7k 0.3.0].BUM+" +repr(params))
...
def kickasstorrents(params):
    plugintools.log("[tv.ultra.7k 0.3.0].KickassTorrents" +repr(params))
...
def kickass_results(params):
    plugintools.log("tv.ultra.7k Kickass Results "+repr(params))
...
def bitsnoop0(params):
    plugintools.log("[tv.ultra.7k 0.3.0].BitSnoop" +repr(params))
...
def bitsnoop1(params):
    plugintools.log("tv.ultra.7k BitSnoop Results "+repr(params))
...
def bitsnoop2(params):
    plugintools.log("tv.ultra.7k BitSnoop GetLink "+repr(params))
...
def isohunt0(params):
    plugintools.log("tv.ultra.7k Isohunt "+repr(params))
...
def isohunt1(params):
    plugintools.log("tv.ultra.7k Isohunt Results "+repr(params))
...
def isohunt2(params):
    plugintools.log("tv.ultra.7k IsoHunt GetLink "+repr(params))
...
def monova0(params):
    ...
    try:
        ...
        texto = texto.lower()
        if texto == "":
            errormsg = plugintools.message("TV Ultra 7K","Por favor, introduzca el término a buscar")
            #return errormsg
        else:
            texto = texto.lower().strip()
            texto = texto.replace(" ", "+")
...
def monova1(params):
    plugintools.log("tv.ultra.7k Monova.org Results "+repr(params))
...
def monova2(params):
    plugintools.log("tv.ultra.7k Monova.org GetLink "+repr(params))
...
def gethttp_headers(url):
    plugintools.log("tv.ultra.7k-0.3.0.gethttp_referer_headers "+url)
    request_headers=[]
