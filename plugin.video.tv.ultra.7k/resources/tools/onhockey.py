# -*- coding: utf-8 -*-
#------------------------------------------------------------
# TV Ultra 7K Parser de onhockey.tv
...
def onhockey(params):
        ...
        datamovie = {}
        datamovie["Plot"]='[B]OnHockey.TV[/B] es un portal de streaming en vivo de las mejores ligas de Hockey, resultados en vivo y chat en varios idiomas.[CR][CR]En exclusiva en [COLOR lightyellow]tv.ultra.7k[/COLOR]'
...
def url_onhockey(url,tipo):
    plugintools.log("[tv.ultra.7k-0.3.0.URL_onHockey "+url)
