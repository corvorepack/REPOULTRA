...
def epg_arena(url):
    plugintools.log("[tv.ultra.7k-0.3.0].EPG EHF.com loading... "+url)
...
def encode_string(txt):
    plugintools.log("[tv.ultra.7k-0.3.0].encode_string: "+txt)
...
def gethttp_noref(url):
    plugintools.log("[tv.ultra.7k-0.3.0.gethttp_noref] "+url)    
...
def compara_times(horas, eventos):
    plugintools.log("[tv.ultra.7k-0.3.1].compara_times")
    print horas, eventos
