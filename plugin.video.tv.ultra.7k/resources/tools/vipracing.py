# -*- coding: utf-8 -*-
#------------------------------------------------------------
# TV Ultra 7K Parser de Vipracing.org
...
def server_vipracing(url_vipracing):
    #plugintools.log("[tv.ultra.7k-0.3.0].server_rtmp " + url_vipracing)
...
def canal_vipracing(canal):
    #plugintools.log("[tv.ultra.7k-0.3.0].canal_vipracing "+canal);#'http://vipracing.tv/index.php?/channel/opcion-2' ;#'http://vipracing.org/channel/opcion-1'
    if canal.find("1") >= 0:
        canal = "opcion-1"
    elif canal.find("2") >= 0:
        canal = "opcion-2"
