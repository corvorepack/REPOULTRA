...
home = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.tv.ultra.7k/', ''))
tools = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.tv.ultra.7k/resources/tools', ''))
addons = xbmc.translatePath(os.path.join('special://home/addons/', ''))
resources = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.tv.ultra.7k/resources', ''))
art = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.tv.ultra.7k/art', ''))
tmp = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.tv.ultra.7k/tmp', ''))
...
# En construcción!
def castalba(params):
    plugintools.log("[tv.ultra.7k-0.3.0].castalba "+repr(params))
...
def castalba(params):
    ...
    if body.find("THIS CHANNEL IS CURRENTLY OFFLINE") > 0 :
        xbmc.executebuiltin("Notification(%s,%s,%i,%s)" % ('TV Ultra 7K', "Canal offline", 3 , art+'icon.png'))
        return 0
    else:
