# -*- coding: utf-8 -*-
#------------------------------------------------------------
# TV Ultra 7K Regex de Shidurlive
...
def shidurlive(params):
    plugintools.log("[tv.ultra.7k-0.3.0].shidurlive "+repr(params))
    url_user = {}
...
def getparams_shidurlive(url_user, body):
    plugintools.log("[tv.ultra.7k-0.3.0].getparams_shidurlive " + repr(url_user) )
