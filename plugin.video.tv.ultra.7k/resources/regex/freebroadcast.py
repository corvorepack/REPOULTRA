# -*- coding: utf-8 -*-
#------------------------------------------------------------
# TV Ultra 7K - XBMC Add-on by Juarrox (juarrox@gmail.com)
...
def freebroadcast(params):
    plugintools.log("[tv.ultra.7k-0.3.0].freebroadcast "+repr(params))
    url_user = {}
...
def getparams_freebroadcast(url_user, body):
    plugintools.log("[tv.ultra.7k-0.3.0].getparams_freebroadcast " + repr(url_user) )
...
def getfile_freebroadcast(url_user, decoded, body):
    plugintools.log("tv.ultra.7k getfile_freebroadcast( "+repr(url_user))
    referer = url_user.get("referer")
...
def get_fileserver(decoded, url_user):
    plugintools.log("tv.ultra.7k fileserver "+repr(url_user))
