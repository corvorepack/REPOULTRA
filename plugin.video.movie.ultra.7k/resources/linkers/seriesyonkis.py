...
def serieyonkis_linker0(params):
    ...
    plugintools.add_item(action="",url="",title="[COLOR lightblue][B] SeriesYonkis"+version+"[/B][COLOR lightblue]"+sc4+"[I] [/I]"+ec4,thumbnail=thumbnail,fanart=fanart,folder=False,isPlayable=False)
