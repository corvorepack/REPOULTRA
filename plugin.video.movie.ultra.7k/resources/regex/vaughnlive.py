# -*- coding: utf-8 -*-
#------------------------------------------------------------
# Movie Ultra 7K Regex de vaughnlive
...
def resolve_vaughnlive(params):
    plugintools.log("[movie.ultra.7k-0.3.0].resolve_vaughnlive " + repr(params) )
...
def gethttp_noref(url):
    plugintools.log("[movie.ultra.7k-0.3.0.Vaughn_Regex] ")    
