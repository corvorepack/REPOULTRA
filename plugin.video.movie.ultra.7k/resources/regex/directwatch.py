# -*- coding: utf-8 -*-
#------------------------------------------------------------
# Movie Ultra 7K Regex de direct2watch
...
def directwatch(params):
    plugintools.log("[movie.ultra.7k-0.3.0].directwatch "+repr(params))
    url_user = {}
...
def gethttp_referer_headers(pageurl, referer):
    plugintools.log("[movie.ultra.7k-0.3.0].gethttp_headers "+pageurl)
