# -*- coding: utf-8 -*-
#------------------------------------------------------------
# Movie Ultra 7K Regex de 9straem
...
def getparams_ninestream(url_user, params, body):
    plugintools.log("[movie.ultra.7k-0.3.0].getparams_ninestream " + repr(url_user) )
...
def getfile_ninestream(url_user, decoded, body):
    plugintools.log("movie.ultra.7k getfile_ninestream( "+repr(url_user))
    referer = url_user.get("referer")
