# -*- coding: utf-8 -*-
#------------------------------------------------------------
# Movie Ultra 7K Regex de freetvcast
...
def freetvcast(params):
    plugintools.log("[movie.ultra.7k-0.3.0].resolve_freetvcast " + repr(params) )
...
def play_freetvcast(freetvcast_user):
    plugintools.log("[movie.ultra.7k-0.3.0].freetvcast User= " + repr(freetvcast_user) )
