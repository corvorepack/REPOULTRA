...
def epg_arena(url):
    plugintools.log("[movie.ultra.7k-0.3.0].EPG EHF.com loading... "+url)
...
def get_program(horas, eventos, url):
    plugintools.log("[movie.ultra.7k-0.3.1].get_program "+url)
...
def encode_string(txt):
    plugintools.log("[movie.ultra.7k-0.3.0].encode_string: "+txt)
...
def compara_times(horas, eventos):
    plugintools.log("[movie.ultra.7k-0.3.1].compara_times")
    print horas, eventos
