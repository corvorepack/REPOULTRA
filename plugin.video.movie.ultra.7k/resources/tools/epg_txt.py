...
def epg_txt_dict(channel):
    ...
    elif channel == "aragon television" or channel == "aragón televisión":  # Autonómicas
        url = 'http://servicios.elpais.com/m/programacion-tv/canal/aragon-television/'        
    elif channel == "aragón tv" or channel == "aragón tv hd":  # Autonómicas
        url = 'http://servicios.elpais.com/m/programacion-tv/canal/aragon-television/'        
    ...
    elif channel == "axn" or channel == "axn hd" or channel == "axn-hd":
        url = 'http://servicios.elpais.com/m/programacion-tv/canal/axn/'
    elif channel == "axn white" or channel == "axn white hd" or channel == "axn-white":
    ...
    elif channel == "c+ acción" or channel == "canal+ acción" or channel == "cplus-accion":
        url = 'http://servicios.elpais.com/m/programacion-tv/canal/cplus-accion/'	
    elif channel == "c+ comedia" or channel == "canal+ comedia" or channel == "cplus-comedia":
        url = 'http://servicios.elpais.com/m/programacion-tv/canal/cplus-comedia/'
    elif channel == "c+ dcine" or channel == "canal+ dcine" or channel == "cplus-dcine":
    ...
    elif channel == "c+ estrenos" or channel == "canal+ estrenos" or channel == "cplus-estrenos":
        url = 'http://servicios.elpais.com/m/programacion-tv/canal/cplus-estrenos/'		
    ...
    elif channel == "c+ series" or channel == "canal+ series" or channel == "cplus-series":
        url = 'http://servicios.elpais.com/m/programacion-tv/canal/cplus-series/'
    elif channel == "c+ series" or channel == "canal+ series xtra" or channel == "cplus-series-xtra":
        url = 'http://servicios.elpais.com/m/programacion-tv/canal/cplus-series-xtra/'
    ...
    elif channel == "calle 13" or channel == "calle 13 hd" or channel == "calle-13":
    ...
    elif channel == "comedy central" or "comedy-central":
    ...
    elif channel == "fox" or channel == "fox hd" or channel == "fox-hd":
        url = 'http://servicios.elpais.com/m/programacion-tv/canal/fox/'
    elif channel == "fox life" or channel == "fox-life":
    ...
    elif channel == "paramount channel" or channel == "paramount-channel":
