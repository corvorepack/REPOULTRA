# -*- coding: utf-8 -*-
#------------------------------------------------------------
# Movie Ultra 7K Parser de laligatv.es
...
def laligatv0(params):
    plugintools.log("[movie.ultra.7k-0.3.0].laligatv.es Playlist Sport Channels( "+repr(params))
...
def adelante_geturl(params):
    plugintools.log("[movie.ultra.7k-0.3.0].LaLigatv.es getURL: "+repr(params))
