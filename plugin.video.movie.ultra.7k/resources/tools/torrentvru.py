# -*- coding: utf-8 -*-
#------------------------------------------------------------
# Movie Ultra 7K Parser de torrent-tv.ru
# Version 0.1 (17.10.2014)
# Version 0.2 (23.08.2015)
#------------------------------------------------------------
...
def torrentvru0(params):
    plugintools.log("[movie.ultra.7k-0.3.0].Torrent-TV.ru Playlist Sport Channels( "+repr(params))
...
def torrentvru_channels(params):
    #plugintools.log("[movie.ultra.7k-0.3.0].Torrent-tv.ru getAcestream: "+url)
...
def torrentvru_getlogo(url_fixed, data):
    #plugintools.log("[movie.ultra.7k-0.3.0].Torrent-tv.ru getLogo: "+url_fixed)
