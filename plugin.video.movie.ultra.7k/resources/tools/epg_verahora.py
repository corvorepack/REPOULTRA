# -*- coding: utf-8 -*-
#------------------------------------------------------------
# EPG ¿Qué ver ahora? para Movie Ultra 7K
...
def epg_verahora(params):
    ...
    plugintools.add_item(action="", title= '[COLOR white][B]Mi Guia TV Ahora[/B][/COLOR]', thumbnail = thumbnail , fanart = fanart , folder = False, isPlayable = False)
    ...
    for entry in body:
        ...
        quever.write('   [COLOR red][B]Ahora: [COLOR white]'+ahora+'[/B][/COLOR]\n')
        quever.write('   [COLOR red][B]'+hora_luego+' [COLOR white]'+evento_luego+' [/COLOR][COLOR green]('+diff_luego+') [/B][/COLOR]\n')
        quever.write('   [COLOR red][B]'+hora_mastarde+' [COLOR white]'+evento_mastarde+'[/B][/COLOR]\n\n')
...
def epg_verluego(params):
    ...
    data = plugintools.read(url)
    #plugintools.log("data= "+data)
    plugintools.add_item(action="", title= '[COLOR white][B]Mi Guia TV Despues[/B][/COLOR]', thumbnail = thumbnail , fanart = fanart , folder = False, isPlayable = False)
...
def epg_vermastarde(params):
    ...
    data = plugintools.read(url)
    #plugintools.log("data= "+data)
    plugintools.add_item(action="", title= '[COLOR white][B]Mi Guia TV Mas Tarde[/B][/COLOR]', thumbnail = thumbnail , fanart = fanart , folder = False, isPlayable = False)
