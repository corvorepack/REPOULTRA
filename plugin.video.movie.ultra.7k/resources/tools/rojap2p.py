...
def rojap2p0(params):
    ...
    plugintools.add_item(action="", title='[B][COLOR orange]RojaDirecta [I]P2P[/I][/B][/COLOR] [COLOR lightyellow] - En exclusiva en [B]Movie Ultra 7K[/B][/COLOR]', url=url, thumbnail=thumbnail, fanart=fanart, folder=False, isPlayable=False)
