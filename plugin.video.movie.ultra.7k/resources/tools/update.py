...
def bajalib(params, platform, libdir, filename):
    plugintools.log("[movie.ultra.7k-0.2.99].bajalib "+platform)
    ...
    xbmc.executebuiltin("Notification(%s,%s,%i,%s)" % ('Movie Ultra 7K', "Librería actualizada!", 3 , art+'icon.png'))
    return 0 #succesful



def get_system_platform(params):
    plugintools.log("[movie.ultra.7k-0.2.99].get_system_platform " + repr(params))
