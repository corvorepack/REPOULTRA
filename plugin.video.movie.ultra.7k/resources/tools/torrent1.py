# -*- coding: utf-8 -*-
#------------------------------------------------------------
# Movie Ultra 7K Regex de 1torrent.ru
...
def torrentone(params):
    plugintools.log("[movie.ultra.7k-0.3.0].Playlist Sport Channels Torrent1( "+repr(params))
...
def gethash_torrentone(params):
    plugintools.log("[movie.ultra.7k-0.3.0].gethash_torrentone( "+repr(params))
