...
cbx_pages = xbmc.translatePath(os.path.join('special://home/userdata/adon_data/plugin.video.movie.ultra.7k/art/cbx', ''))
playlists = xbmc.translatePath(os.path.join('special://home/userdata/addon_data/plugin.video.movie.ultra.7k/playlists', ''))
tmp = xbmc.translatePath(os.path.join('special://home/userdata/addon_data/plugin.video.movie.ultra.7k/tmp', ''))
...
def addDir( action="" , title="" , plot="" , url="" , thumbnail="" , fanart="" , show="" , episode="" , extra="", page="", info_labels = None, isPlayable = False , folder=True ):
    _log("add_item action=["+action+"] title=["+title+"] url=["+url+"] thumbnail=["+thumbnail+"] fanart=["+fanart+"] show=["+show+"] episode=["+episode+"] extra=["+extra+"] page=["+page+"] isPlayable=["+str(isPlayable)+"] folder=["+str(folder)+"]")
